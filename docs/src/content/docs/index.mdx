...
<Card title="Auth Flow" icon="open-book">
  ...
  <Card title="Unit + E2E tests" icon="document">
		We provide a complete setup for unit and end-to-end tests using Vitest and React Testing Library, along with Meastro for end-to-end testing. This will assist you in writing tests for your app and ensuring that it functions as expected.
	</Card>
</CardGrid>
